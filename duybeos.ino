...
// Servo variables
long term = 10000; // Default term in milliseconds
long nextSpinTime = 0;
...
void setup() {
  ...
  // Sign up to Firebase anonymously
  ...
  // Initialize servo settings in Firebase if they don't exist
  ...
  // Initialize timing for servo spin
...
void loop() {
  ...
  delay(100); // Small delay to prevent overwhelming Firebase
}